...
type дополнительныеОбработчики interface {
	...
	СконвертироватьФайлы(ПУтьКФайлуКофнигурации string) (err error)
}
...
func (conf *Конфигуратор) СконвертироватьФайлы(ПУтьКФайлуКофнигурации string) (err error) {

	var Параметры []string

	Параметры = append(Параметры, "/ConvertFiles", ПУтьКФайлуКофнигурации)
